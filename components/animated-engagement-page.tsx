            ...
            <div className="relative z-10 text-center space-y-12">
              ...
              >
                ...
                >
                  ...
                  <span className="block">Miram</span>
                </motion.h1>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-bold text-foreground">July 31, 2026</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-bold text-foreground">Renaissance Hotel, Mirage City</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
      ...
      <section id="countdown" className="relative py-20 md:py-32 overflow-hidden bg-transparent">
        ...
        >
          ...
          <motion.div
            ...
            className="relative"
          >
            <CountdownTimer targetDate={new Date("2026-07-31T17:00:00")} />
          </motion.div>
        </motion.div>
      </section>
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      <div className="flex items-center gap-4 text-lg">
                        ...
                        <span className="text-xl font-bold text-foreground">July 31, 2026</span>
                      </div>
                      ...
                      <div className="flex items-center gap-4 text-lg">
                        ...
                        <span className="text-xl font-bold text-foreground">5:00 PM</span>
                      </div>
                    </motion.div>
                  </div>
                </div>
